...
- public static KeyPair getKeyPairFromPrivateKey(ECPrivateKey privateKey) - функція отримання ключової пари по даному приватному ключу. Використовується при вході до акаунту.
...
- Set<Robot> robots - "баланс" акаунту (об'єкти класу Robot, якими володіє даний акаунт).
...
- public Set<Robot> fromList(List<dynamic> robotList) - використовується для зручного розпарсингу списку даних по роботах з robotDatabase в сет роботів.
